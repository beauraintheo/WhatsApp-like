...
class _LoginPageState extends State<LoginPage> {
  ...
  String? validator(String? value, String key) {
    ...
    if (key == "phonenumber" && phoneNumberValidator(value))
      return "Veuillez entrer un numéro de téléphone valide";
    if (key == "email" && emailValidator(value))
      return "Veuillez entrer une adresse email valide";
    if (key == "password" && passwordValidator(value))
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          textFieldWidget(_email, false, false, const Icon(Icons.email),
              "Entrez votre email", "Email", "email"),
          sizedBoxWidget(16),
          textFieldWidget(_password, true, true, const Icon(Icons.lock),
              "Entrez votre mot de passe", "Mot de passe", "password"),
          sizedBoxWidget(24),
          button()
        ],
      ),
  ...
  Widget appLogo() => Container(
      ...
      decoration: BoxDecoration(
          ...
          image: const DecorationImage(
              image: AssetImage("assets/danganronpa.png"), fit: BoxFit.fill)));
  ...
  Widget paddingButtonWidget(double paddingX, double paddingY, String text) =>
      Padding(
  ...
  Widget additionalsElements() => Column(
        children: [
          textFieldWidget(_firstname, false, false, const Icon(Icons.person),
              "Entrez votre prénom", "Prénom", "firstname"),
          sizedBoxWidget(16),
          textFieldWidget(_lastname, false, false, const Icon(Icons.person),
              "Entrez votre nom", "Nom", "lastname"),
          sizedBoxWidget(16),
          textFieldWidget(
              _phonenumber,
              false,
          ...
          image != null
              ? avatarWidget(image)
              : SizedBox(width: 350, child: uploadAvatar("Choisir un avatar")),
          sizedBoxWidget(16),
        ],
      );
      ...
      SizedBox(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                errorText: formFieldsDirty[key] &&
                        validator(controller.text, key) != null
  ...
  Widget uploadAvatar(String label) =>
      ElevatedButton(onPressed: popinUploadAvatar, child: Text(label));
  ...
  Widget button() => ElevatedButton(
      onPressed: () => selection[0]
          ...
          : FirebaseManager()
              .subscribe(_firstname.text, _lastname.text, _email.text,
